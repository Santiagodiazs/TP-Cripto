# Test 25: round-trip k=7 n=8

## Entrada
1. `./sss -d -secret secret_300.bmp -k 7 -n 8 -dir <workdir con 10 portadoras 300×300>`
2. `./sss -r -secret recovered.bmp -k 7 -dir <misma workdir>`
