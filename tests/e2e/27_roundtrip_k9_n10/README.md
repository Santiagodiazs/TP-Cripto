# Test 27: round-trip k=9 n=10

## Entrada
1. `./sss -d -secret secret_300.bmp -k 9 -n 10 -dir <workdir con 10 portadoras 300×300>`
2. `./sss -r -secret recovered.bmp -k 9 -dir <misma workdir>`
