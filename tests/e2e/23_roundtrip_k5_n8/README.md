# Test 23: round-trip k=5 n=8

## Entrada
1. `./sss -d -secret secret_300.bmp -k 5 -n 8 -dir <workdir con 10 portadoras 300×300>`
2. `./sss -r -secret recovered.bmp -k 5 -dir <misma workdir>`
