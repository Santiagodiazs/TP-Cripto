# Test 28: round-trip k=10 n=10

## Entrada
1. `./sss -d -secret secret_300.bmp -k 10 -n 10 -dir <workdir con 10 portadoras 300×300>`
2. `./sss -r -secret recovered.bmp -k 10 -dir <misma workdir>`

## Salida esperada
- Ambas invocaciones: exit code = 0.
- Tras la distribución, las 10 primeras portadoras de la workdir tienen sombras embebidas
